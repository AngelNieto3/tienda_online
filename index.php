...
<html lang="en">
  <head>
    ...
    <title style="background-color: black;">Kawschool Store</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./panel/index.php">panel</a>
        </div>
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <?php
                          ...
                          if(file_exists($foto)){
                        ?>
                          <img src="<?php print $foto; ?>"  width="230" height="340">
                      <?php 
                      }else{
                      ?>
                    ...
                    ?>
                      <div class="panel-heading">
                        <h1 class="text-center titulo-pelicula"><?php print "No Disponible" ?></h1> 
                        <br>
                        <br>
                        <br>
                        <br> 
                    ...
                    ?>
                      <div class="panel-heading">
                        <h1 class="text-center titulo-pelicula"><?php print "N.Unidades: ".$item['cantidad'] ?></h1>  
                      </div>
